...
function App() {
  ...
  // Main Application Layout for all authenticated views
  if (user) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-cream-50 to-rose-50">
        {/* Match Notification */}
        ...
        <div className="flex-1">
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex flex-col">
                            ...
                            {/* Online Status */}
                            <div className="mt-1">
                              {getOnlineStatusIndicator(profile.last_activity, 
                                onlineUsers.some(u => u.id === profile.id)
                              )}
                            </div>
                          </div>
                          <div className="flex flex-col space-y-2">
                            <button 
                              className="px-4 py-2 bg-gradient-to-r from-purple-600 to-rose-500 text-white text-sm rounded-lg font-medium hover:from-purple-700 hover:to-rose-600 transition-all duration-300"
                            >
                              View Profile
                            </button>
                            <button 
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="flex items-center space-x-3">
                                ...
                                <button 
                                  ...
                                  className="px-6 py-2 bg-gradient-to-r from-purple-600 to-rose-500 text-white text-sm rounded-lg font-medium hover:from-purple-700 hover:to-rose-600 transition-all duration-300 flex items-center space-x-2 disabled:opacity-50"
                                  disabled={!match.id || !match.name}
                                >
          ...
          {/* Chat Rooms View */}
          {currentView === 'chat' && userSubscription?.subscription_tier === 'premium' && (
            <div className="flex h-screen pt-0 bg-gradient-to-br from-purple-50/50 to-rose-50/50">
